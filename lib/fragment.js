...
Fragment.prototype._maxListeners = 30
...
Fragment.prototype.observe = function(model, property) {
  ...
  utils.observe('changed' + (property ? '.' + property : '')).until('delete', this)
       .call(this, 'refresh')
       .on(model)
  
  if (model === utils.requestContext) return
...
Fragment.prototype.render = function() {
  ...
  return this.template.fn.apply(this.context, this.args || []) || ''
}
...
Fragment.prototype.insert = function(context, index) {
  ...
  var fragment = this.factory
    ? this.factory.new(42, this.template, this.context)
    : new Fragment(42, this.template, this.context)
  fragment.args = this.args.slice()
  fragment.args.push(context)
