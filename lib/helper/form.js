...
Forms.formFor = function formFor(/* model, [attrs], definition */) {
  ...
  if (definition) buf.push(definition.call(forms, forms))
...
Forms.prototype.label = function(prop, content, attrs) {
  this.get(prop)
  var html = Forms.labelFor.apply(Forms,
    [this.model].concat(Array.prototype.slice.call(arguments)))
  if (this.buf) this.buf.push(html)
  return html
}

Forms.textareaFor = function (/*model, prop, content, attrs, options*/) {
...
Forms.prototype.textarea = function(prop, content, attrs) {
  this.get(prop)
  var html = Forms.textareaFor.apply(Forms,
    [this.model].concat(Array.prototype.slice.call(arguments)))
  if (this.buf) this.buf.push(html)
  return html
}
...
Forms.prototype.input = function (type, prop, value, attrs) {
  this.get(prop)
  var html = Forms.inputFor.apply(Forms,
    [this.model].concat(Array.prototype.slice.call(arguments)))
  if (this.buf) this.buf.push(html)
  return html
}
...
Forms._inputTypes.forEach(function (type) {
  ...
  Forms.prototype[type + 'Field'] = function(prop, value, attrs)  {
    this.get(prop)
    return Forms.inputFor.apply(Forms,
