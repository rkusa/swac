...
API.prototype.get = function(id, callback) {
  var that = this
  this.request('get', id, function(data) {
...
API.prototype.list = function(/* view, key, callback */) {
  var that = this
    ...
    , callback = args.pop()
  this.request.apply(this, ['list'].concat(args, function(data) {
...
API.prototype.put = function(instance, callback) {
  var that = this
  this.request('put', instance, function(data) {
...
API.prototype.post = function(instance, callback) {
  var that = this
  this.request('post', instance, function(data) {
...
API.prototype.delete = function(instance, callback) {
  this.request('delete', instance, function(data) {
    callback(null)
  })
}
