...
State.prototype.area = function area(name, fn) {
  ...
  area[name] = function() {
    var template = new Template(fn)
      , fragment = new Fragment(that.original.fragments.length, template, that.original)
...
State.prototype.block = function(fn) {
  ...
  fragment.parent = arguments.callee.caller.fragment
...
State.prototype.collection = function(/* context, [opts,] fn */) {
  ...
  list.parent = arguments.callee.caller.fragment
