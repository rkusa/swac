...
var State = module.exports = function() {
  ...
  // TODO
  // this.register('flashs', Observable.Array(State.Flash))
}

utils.eventify(State)
implode.register('swac/State', State, ['fragments', 'sections', 'views', 'path', '_events', 'nextFragmentId'])
...
State.prototype.init = function() {
  return '<script type="text/javascript">\n' +
         '  window.app = require(\'swac\').State.init(\'' + this.compress() + '\')\n' +
         '</script>'
}
...
// TODO
// State.Flash = Model.define('Flash', function() {
//   this.property('type')
//   this.property('title')
