...
State.prototype.area = function(name, template) {
  ...
  fragment.observe = function() {}
  // delete fragment.fn.fragment
...
State.prototype.collection = function(/* context, [opts,] fn */) {
  ...
  for (var i = 0; i < context.length; ++i) {
    context[i].block = this.block.bind(this, context[i])
    ...
    if (opts.silent) fragment.observe = function() {}
    // if (opts.silent) delete fragment.fn.fragment
    this.fragments[fragment.id] = fragment
