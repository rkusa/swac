...
var State = module.exports = function() {
  ...
  this.html.formFor = this.html.formFor.bind(this)
  ...
  ;['list', 'get', 'post', 'put', 'delete'].forEach(function(method) {
    that[method] = db.bind(that, method)
  })
}
  ...
  Model.authorizeWrite(
    ...
    function(body) {
      ...
      args[args.length - 1] = function(err, result) {
        ...
        var output = Model.authorizeRead(model, that.req, method, result)
