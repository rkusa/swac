...
razorjs.section = function section(name, section) {
  ...
  if (name === 'main' && !app.currentViewIsMain) return ''
  process.domain.app.registerSection(name, razorjs.wrap([], section))
  return ''
}
...
var viewHelper = razorjs.helper
razorjs.helper = function(name, args, fn) {
  process.domain.app.$contract.push(name)
  return 'this.' + name + ' = ' + 'function helper(' + args.join(', ') + ') {\n'
       + 'var _b = [];\n'
...
exports.area = function(target, opts) {
  ...
  !function() {
    ...
    utils.ready(function() {
      ...
      bundle.external(path.normalize(__dirname + '/../index.js'))
      bundle.external(__dirname + '/adapter/ajax.js')
      bundle.external(__dirname + '/helper/form.js')
      bundle.external(__dirname + '/helper/utils.js')
      bundle.external(__dirname + '/attribute.js')
      bundle.external(__dirname + '/collection.js')
      bundle.external(__dirname + '/eventemitter.js')
      bundle.external(__dirname + '/fragment.js')
      bundle.external(__dirname + '/implode.js')
      bundle.external(__dirname + '/index.js')
      bundle.external(__dirname + '/model.js')
      bundle.external(__dirname + '/observable.js')
      bundle.external(__dirname + '/routing.js')
      bundle.external(__dirname + '/state.js')
      bundle.external(__dirname + '/template.js')
      bundle.external(__dirname + '/utils.js')
      bundle.external(path.normalize(__dirname + '/../node_modules/revalidator/lib/revalidator.js'))
      bundle.external(path.normalize(__dirname + '/../node_modules/page/index.js'))
      bundle.external(path.normalize(__dirname + '/../node_modules/qs/index.js'))
...
function initialize() {
  ...
  utils.ready(function() {
    ...
    commons.require(path.resolve(__dirname + '/../index.js'))
