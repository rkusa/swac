...
Route.prototype.execute = function(app, req, callback) {
  if (swac.isClient && this.rdy) this.rdy(app, req.params)
...
Route.prototype.revert = function(app) {
...
Route.prototype.executeUntil = function(to, req, res) {
  ...
  var done = function done() {
    ...
    route.execute(req.app, req, callback)
  }
  done.end      = finalize
