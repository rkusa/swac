  ...
  model.prototype.property = function(key, opts) {
    ...
    Object.defineProperty(this, key, {
      ...
      set: function(newValue) {
        var that = this
          , changed = function() {
          utils.debug('[Model] "%s"\'s Property "%s" got changed ... forwarding Event to its Model', this._position || name, key)
        ...
        if (Array.isArray(newValue)) {
          ...
          if (value && !value.hasOwnProperty('_position')) {
            Object.defineProperty(value, '_position', {
              value: this._position + '.' + key,
              writable: true
            })
          } else value._position = this._position + '.' + key
